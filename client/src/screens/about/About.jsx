...
function About() {
  return (
    <div>
      ...
      <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1fnEgX2b9t4NGHhBwP2Yrey427OVb5aUM/view?usp=sharing"><button type="button" className="resume">Resume</button></a>
