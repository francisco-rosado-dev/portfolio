...
function About() {
  return (
    <div>
      ...
      <a target="_blank" rel="noreferrer" href="https://www.canva.com/design/DAEtYeoV1Hc/7YQzfVyZZS8s6rEjyZ_3yQ/view?utm_content=DAEtYeoV1Hc&utm_campaign=designshare&utm_medium=link&utm_source=sharebutton"><button type="button" className="resume">Resume</button></a>
