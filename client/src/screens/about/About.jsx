...
function About() {
  return (
    <div>
      ...
      <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1oeMpoishYc8-G-3ptfvKs0aNrWNKRxa0/view?usp=sharing"><button type="button" className="resume">Resume</button></a>
