...
function About() {
  return (
    <div>
      ...
      <a target="_blank" rel="noreferrer" href="https://drive.google.com/file/d/1HYmJOAvuauXhxxvTpo0T1QhXJFdQclyf/view?usp=sharing"><button type="button" className="resume">Resume</button></a>
