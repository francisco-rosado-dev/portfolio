  ...
  return (
    <div className="projectsContainer">
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/francisco-rosado-dev/SpaceSearch"><button type="button" className="portfolioLinks">View Code</button></a>
      ...
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/francisco-rosado-dev/human-coin"><button type="button" className="portfolioLinks">View Code</button></a>
      ...
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/yeana-dev/YSFJ/tree/main"><button type="button" className="portfolioLinks">View Code</button></a>
      ...
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://github.com/francisco-rosado-dev/musicphile"><button type="button" className="portfolioLinks">View Code</button></a>
