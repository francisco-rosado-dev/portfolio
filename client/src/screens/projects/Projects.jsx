  ...
  return (
    <div className="projectsContainer">
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://https://github.com/francisco-rosado-dev/human-coin"><button type="button" className="portfolioLinks">GitHub</button></a>
        <a target="_blank" rel="noreferrer" href="https://https://human-coin.netlify.app/"><button type="button" className="portfolioLinks">Live Site</button></a>
      </div>
      <div className="project">
        ...
        <a target="_blank" rel="noreferrer" href="https://https://ysfj.netlify.app/"><button type="button" className="portfolioLinks">Live Site</button></a>
      </div>
      <div className="project">
